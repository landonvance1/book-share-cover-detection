...
class Settings(BaseSettings):
    ...
    onnx_processor_name: str = "microsoft/Florence-2-base-ft"

    # HuggingFace model name or local path for the PyTorch engine (used when ocr_engine="pytorch").
    pytorch_model_name: str = "microsoft/Florence-2-base"
    ...
    gliner_model_revision: str = "abd49a1f1ebc12af1be84d06f6848221cf96dcad"
